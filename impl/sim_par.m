function batch = sim_par(batch, data_queue)
% Simulate batch using parallel for loop
    ...
    % Extract loop variables (needed for parfor)
    type    = batch.type;
    cw_tol  = batch.conv_cw_tol;
    var_tol = batch.conv_var_tol;
    ...
    parfor idx = 1:last
        ...
        for series = 1:systems(idx).budget
            ...
            systems(idx) = update_state(systems(idx), systems(idx).series, cw_tol, var_tol);
